...
function SignIn() {
  ...
  return (
    <main className="container max-w-2xl px-6 mx-auto">
      ...
      <div className="flex flex-col overflow-hidden shadow-md shadow-blue-500 bg-blue-400 rounded-2xl">
        <div className="h-52">
          <img
            className="object-cover w-full h-full"
            src="https://images.pexels.com/photos/5849577/pexels-photo-5849577.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          />
        </div>
